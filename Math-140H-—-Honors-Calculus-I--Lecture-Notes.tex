...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title={Check your guesses numerically}, titlerule=0mm, toprule=.15mm, toptitle=1mm]

The notebook
\href{notebooks/Week02_Epsilon_Delta_Game.ipynb}{\texttt{Week02\_Epsilon\_Delta\_Game.ipynb}}
lets you set \(\varepsilon\) with a slider, type in your \(\delta\), and
see the exact range of values \(f\) takes on \((1-\delta,\,1+\delta)\)
--- together with a verdict on whether your \(\delta\) wins the game.
